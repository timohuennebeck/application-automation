...
import { FieldHint, ModalShell } from '../../ui/ModalShell';
...
export function ProfileModal() {
  ...
  return (
    <ModalShell
      onClose={() => set({ profileOpen: false })}
      header={<div style={{ fontSize: 15, fontWeight: 600 }}>Profil</div>}
    >
      <FieldHint>
        Deine beiden HTML-Templates. Für jede Bewerbung wird eine Kopie davon ausgefüllt und als PDF
        exportiert — die Originale hier bleiben unberührt.
      </FieldHint>
