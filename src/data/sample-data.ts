...
export const DETAILS: Record<string, DetailDef> = {
  'BEW-33': {
    facts: [
      ...
      ['E-Mail', 'jobs@vectorlabs.ch', FactKind.LINK],
      ['Beworben am', '24.07.2026'],
      ['Letzter Kontakt', 'vor 12 Tagen'],
      ['Kontaktperson', 'Nadine Wolf'],
      ['Kontaktperson E-Mail', 'n.wolf@vectorlabs.ch', FactKind.LINK],
  ...
  'BEW-35': {
    facts: [
      ...
      ['E-Mail', 'karriere@helios-energie.de', FactKind.LINK],
      ['Beworben am', '01.08.2026'],
      ['Letzter Kontakt', 'vor 5 Tagen'],
      ['Kontaktperson', 'Lea Brinkmann'],
      ['Kontaktperson E-Mail', 'l.brinkmann@helios.de', FactKind.LINK],
  ...
  'BEW-29': {
    facts: [
      ...
      ['E-Mail', 'bewerbung@brandt-digital.de', FactKind.LINK],
      ['Beworben am', '21.07.2026'],
      ['Letzter Kontakt', 'vor 6 Tagen'],
      ['Kontaktperson', 'Ines Faber'],
      ['Kontaktperson E-Mail', 'i.faber@brandt-digital.de', FactKind.LINK],
