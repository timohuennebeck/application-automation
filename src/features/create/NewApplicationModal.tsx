...
export function NewApplicationModal() {
  ...
  const togglePerson = (key: string) => set((s) => ({
    jobPeople: s.jobPeople.includes(key)
      ? s.jobPeople.filter((k) => k !== key)
      : [...s.jobPeople, key],
  }));
    ...
    >
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
        <input
          ...
          style={{
            fontSize: 15, color: 'var(--c-1b1a17)', lineHeight: 1.5, border: 'none', outline: 'none',
            background: 'transparent', width: '100%', minWidth: 0, padding: 0,
          }}
        />
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 8, paddingTop: 4 }}>
        ...
        <textarea
          ...
          style={{
            fontSize: 13.5, color: 'var(--c-1b1a17)', lineHeight: 1.55, fontFamily: 'inherit',
            border: 'none', boxShadow: 'inset 0 0 0 1px var(--c-cfccc3)', borderRadius: 6, padding: '8px 10px',
            outline: 'none', resize: 'vertical', background: 'var(--c-fff)',
            ...
            {directory.map((p) => {
              ...
              return (
                <div
                  ...
                  style={{ display: 'flex', alignItems: 'center', gap: 9, padding: '5px 8px', borderRadius: 7, minWidth: 0, background: sel ? 'var(--c-f1efe9)' : 'transparent' }}
                >
                  <div style={{
